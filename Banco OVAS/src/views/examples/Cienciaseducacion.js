...
import CienciaseducacionHeader from "components/Headers/CienciaseducacionHeader.js";
    ...
    <div class="col-md-12">
        <ul class="list-group">
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <img alt="..." src={require("assets/img/educacion.png")} ></img>
